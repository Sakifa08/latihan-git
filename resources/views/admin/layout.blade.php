    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Kifa Digital Marketing</div>
            </a>
            ...
            <li class="nav-item {{ request()->is('admin/about_us') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/about_us">
                <i class="fas fa-fw fa-folder"></i>
                    <span>Tentang Kami</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item {{ request()->is('admin/klien_kami') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/klien_kami">
                <i class="fas fa-fw fa-folder"></i>
                    <span>Klien</span></a>
            </li>
